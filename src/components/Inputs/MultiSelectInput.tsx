  ...
  return (
    <div className={`p-2 ${className}`} ref={containerRef}>
      ...
      <div className="relative">
        ...
        <div
          className={`w-full min-h-[42px] px-3 py-1.5 border border-gray-300 rounded-md focus-within:ring-2 focus-within:ring-primary focus-within:border-transparent ${
            disabled
          ...
          <div className="flex flex-wrap gap-1 items-center">
            {selectedOptions.length > 0 ? (
              selectedOptions.map((opt) => (
                <span
                  key={opt.value}
                  className="inline-flex items-center bg-primary-50 text-primary text-sm rounded-full px-3 py-0.5"
                >
                  {opt.label}
                  <button
                    type="button"
                    ...
                    className="ml-1 text-primary hover:text-primary-700 focus:outline-none"
                    disabled={disabled}
                  >
                    <svg
                      className="w-3 h-3"
